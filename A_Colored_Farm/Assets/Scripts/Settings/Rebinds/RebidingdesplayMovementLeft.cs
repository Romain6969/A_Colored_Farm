...
public class RebidingdesplayMovementLeft : MonoBehaviour
{
    ...
    {
        _bindingDisplayNameText.text = InputControlPath.ToHumanReadableString(_actionMovement.action.bindings[3].effectivePath);
