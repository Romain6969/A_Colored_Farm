        ...
        switch (_id)
        {
            case 0:
                if (_inventoryMain.Money >= _seedMain.GreySeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.GreySeed, 1);
                }
                break;
            case 1:
                if (_inventoryMain.Money >= _seedMain.BlueSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.BlueSeed, 1);
                }
                break;
            case 2:
                if (_inventoryMain.Money >= _seedMain.YellowSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.YellowSeed, 1);
                }
                break;
            case 3:
                if (_inventoryMain.Money >= _seedMain.RedSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.RedSeed, 1);
                }
                break;
            case 4:
                if (_inventoryMain.Money >= _seedMain.PurpleSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.PurpleSeed, 1);
                }
                break;
            case 5:
                if (_inventoryMain.Money >= _seedMain.GreenSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.GreenSeed, 1);
                }
                break;
            case 6:
                if (_inventoryMain.Money >= _seedMain.OrangeSeed.PurchaseValue)
                {
                    ...
                    _inventoryMain.InventorySeed.AddSeed(_seedMain.OrangeSeed, 1);
                }
                break;
        }
    }
